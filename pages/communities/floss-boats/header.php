							...
							<ul class="sf-menu template-clear-fix">
								...
								<li class="sf-mega-enable-0">
									...
									<ul>
										...
										<li><a href="../../about#skills">Skills</a></li>
									</ul>
								</li>
								<!-- Trainings Menu -->
								<li class="sf-mega-enable-0">
								...
								<!-- Communities Menu -->
								<li class="sf-mega-enable-0">
									<a href="../community-innovation/index.php"><span class="template-icon-menu template-icon-menu-people"></span>Communities</a>
									<ul>
										<li><a href="../community-innovation/index.php">Community Innovation</a></li>
										<li><a href="../dream-terrace/index.php">DreamTerrace</a></li>
										<li><a href="../urban-farming/index.php">Urban Farming</a></li>
										<li><a href="../digital-nomads/index.php">Digital Nomads</a></li>
										<li><a href="../smart-mobility/index.php">Smart Mobility</a></li>
										<li><a href="index.php">Floss Boats</a></li>
										<li><a href="../underwater-vehicles/index.php">Underwater Vehicles</a></li>
									</ul>
								</li>
								<!-- Links Menu -->
								<li class="sf-mega-enable-0">
