...
<div class="template-main template-padding-bottom-5" id="infrastructure">
    ...
    <div class="template-layout-column-left">
        <div class="template-component-nivo-slider template-component-nivo-slider-style-1 template-preloader">
            <div>
                <img src="../media/gallery/infrastructure-business-lab-dreamspace-1.jpg"
                    data-thumb="../media/gallery/infrastructure-business-lab-dreamspace-1.jpg" alt="DreamSpace Academy" />
                <img src="../media/gallery/infrastructure-business-lab-dreamspace-2.jpg"
                    data-thumb="../media/gallery/infrastructure-business-lab-dreamspace-2.jpg" alt="DreamSpace Academy" />
                <img src="../media/gallery/infrastructure-business-lab-dreamspace-3.jpg"
                    data-thumb="../media/gallery/infrastructure-business-lab-dreamspace-3.jpg" alt="DreamSpace Academy" />
                <img src="../media/gallery/infrastructure-business-lab-dreamspace-4.jpg"
                    data-thumb="../media/gallery/infrastructure-business-lab-dreamspace-4.jpg" alt="DreamSpace Academy" />
                <img src="../media/gallery/infrastructure-business-lab-dreamspace-5.jpg"
                    data-thumb="../media/gallery/infrastructure-business-lab-dreamspace-5.jpg" alt="DreamSpace Academy" />
            </div>
        </div>
    </div>
        ...
        <div class="template-component-call-to-action template-component-call-to-action-style-2 template-section-white">
            <div class="template-component-call-to-action-content">
                <div class="template-component-call-to-action-content-left">
                    <h6>
                        If you want to be part of Business Lab at DreamSpace Academy as an impact investor, partner, donor,
