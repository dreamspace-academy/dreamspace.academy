		...
		<div class="template-component-header-subheader">
			<h3>
				...
				<span>
                    ...
                    Nanotechnology is still a relatively novel area in Sri Lanka. We strongly believe that nanotechnology has the huge potential to transform people’s lives for the better. Our nano lab is established for creating opportunities for learning and discovering nanotechnology to ameliorate the future of Sri Lanka.Our mission is to give opportunities to the enthusiasts who have the finest mind to fiddle with molecule scale structures, and to build practical dexterity in nanotechnology.
                    </p>
				</span>
...
<div class="template-main template-padding-bottom-5" id="infrastructure">
	...
	<div class="template-layout-column-left">
		<div class="template-component-nivo-slider template-component-nivo-slider-style-1 template-preloader">
			<div>
				<img src="../media/gallery/infrastructure-nano-lab-dreamspace-1.jpg" data-thumb="../media/gallery/infrastructure-nano-lab-dreamspace-1.jpg" alt="DreamSpace Academy" />
				<img src="../media/gallery/infrastructure-nano-lab-dreamspace-2.jpg" data-thumb="../media/gallery/infrastructure-nano-lab-dreamspace-2.jpg" alt="DreamSpace Academy" />
				<img src="../media/gallery/infrastructure-nano-lab-dreamspace-3.jpg" data-thumb="../media/gallery/infrastructure-nano-lab-dreamspace-3.jpg" alt="DreamSpace Academy" />
			</div>
		</div>
	</div>
    ...
    <div class="template-component-gallery">
      ...
      <li class="template-layout-column-left">
        ...
        <li class="template-layout-column-center-left">
            ...
            <div class="template-component-social-icon template-component-social-icon-style-1 template-clear-fix">
              <ul>
                <li><a target="_blank" href="https://www.linkedin.com/in/ravini-hettiarachchi-9456ab204">
                    <i class="fab fa-linkedin-in fa-lg" style="color: white; padding-top: 17px;"></i>
                  </a></li>
