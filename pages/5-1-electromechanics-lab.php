            ...
            <h3>
                ...
                <span>
                    ...
                    <p style="font-size:25px; color:#707070;">
                        ...
                        harness the potential electromechanical resources within ecological boundaries.
                    </p>
                </span>
            </h3>
        </div>
            ...
            <ul class="template-layout-25x25x25x25 template-clear-fix">
                <li class="template-layout-column-left">
                    <div
                        ...
                        <img src="../media/gallery/workshop-electromechanics-lab-dreamspace-1.jpg"
                ...
                <li class="template-layout-column-center-left">
                    <div
                        class="template-component-image template-component-counter-box-counter template-component-image-hover-slide-enable template-fancybox template-preloader">
                        <img src="../media/gallery/workshop-electromechanics-lab-dreamspace-2.jpg"
                            alt="DreamSpace Academy" />
                    </div>
                ...
                <li class="template-layout-column-center-right">
                    <div
                        class="template-component-image template-component-counter-box-counter template-component-image-hover-slide-enable template-fancybox template-preloader">
                        <img src="../media/gallery/workshop-electromechanics-lab-dreamspace-3.jpg"
                            alt="DreamSpace Academy" />
                    </div>
                ...
                <li class="template-layout-column-right">
                    <div
                        class="template-component-image template-component-counter-box-counter template-component-image-hover-slide-enable template-fancybox template-preloader">
                        <img src="../media/gallery/workshop-electromechanics-lab-dreamspace-4.jpg"
                            alt="DreamSpace Academy" />
                    </div>
                ...
                <li class="template-layout-column-left">
                    <div
                        class="template-component-image template-component-counter-box-counter template-component-image-hover-slide-enable template-fancybox template-preloader">
                        <img src="../media/gallery/workshop-electromechanics-lab-dreamspace-5.jpg"
                            alt="DreamSpace Academy" />
                    </div>
                ...
                <li class="template-layout-column-center-left">
                    <div
                        class="template-component-image template-component-counter-box-counter template-component-image-hover-slide-enable template-fancybox template-preloader">
                        <img src="../media/gallery/workshop-electromechanics-lab-dreamspace-6.jpg"
                            alt="DreamSpace Academy" />
                    </div>
                ...
                <li class="template-layout-column-center-right">
                    <div
                        class="template-component-image template-component-counter-box-counter template-component-image-hover-slide-enable template-fancybox template-preloader">
                        <img src="../media/gallery/workshop-electromechanics-lab-dreamspace-7.jpg"
                            alt="DreamSpace Academy" />
                    </div>
                ...
                <li class="template-layout-column-right">
                    <div
                        class="template-component-image template-component-counter-box-counter template-component-image-hover-slide-enable template-fancybox template-preloader">
                        <img src="../media/gallery/workshop-electromechanics-lab-dreamspace-8.jpg"
                            alt="DreamSpace Academy" />
                    </div>
                ...
                <li class="template-layout-column-center-left">
                    <div
                        ...
                        <div
                            ...
                            <ul>
                                <li><a target="_blank"
                                        href="https://www.linkedin.com/in/bhargav-kalisar-ramachandra-ab625a1b/">
                                        <i class="fab fa-linkedin-in fa-lg"
                                            style="color: white; padding-top: 17px;"></i>
                                    </a></li>
                            </ul>
        ...
        <div class="template-component-call-to-action template-component-call-to-action-style-2 template-section-white">
            <div class="template-component-call-to-action-content">
                <div class="template-component-call-to-action-content-left">
                    <h6>
                        If you want to be part of Electromechanics Lab at DreamSpace Academy as an impact investor,
                        partner, donor, team member or trainee, please reach out to us !!!
                    </h6>
                </div>
