            ...
            <h3>
                ...
                <span>
                    ...
                    <p style="font-size:25px; color:#707070;">
                        Our mission is deep-rooted in establishing a sustainable peacebuilding through music to help
                        communities address the many stages of conflict in a more constructive and creative way and
                        making it in the music industry in Sri Lanka.
                        <br><br>
                        Music Lab of DreamSpace if focusing on make peace through music, social harmony through music,
                        social awareness through music, innovations in music, music recording, sound recording and
                        research, education and training, identify people who are interested in music and encourage
                        them, music band, techno music and many other fields of interest.
                    </p>
                </span>
...
<div class="template-main template-padding-bottom-5" id="infrastructure">
    ...
    <div class="template-layout-column-left">
        <div class="template-component-nivo-slider template-component-nivo-slider-style-1 template-preloader">
            <div>
                <img src="../media/gallery/infrastructure-music-lab-dreamspace-1.jpg"
                    data-thumb="../media/gallery/infrastructure-music-lab-dreamspace-1.jpg" alt="DreamSpace Academy" />
                <img src="../media/gallery/infrastructure-music-lab-dreamspace-2.jpg"
                    data-thumb="../media/gallery/infrastructure-music-lab-dreamspace-2.jpg" alt="DreamSpace Academy" />
                <img src="../media/gallery/infrastructure-music-lab-dreamspace-3.jpg"
                    data-thumb="../media/gallery/infrastructure-music-lab-dreamspace-3.jpg" alt="DreamSpace Academy" />
                <img src="../media/gallery/infrastructure-music-lab-dreamspace-4.jpg"
                    data-thumb="../media/gallery/infrastructure-music-lab-dreamspace-4.jpg" alt="DreamSpace Academy" />
                <img src="../media/gallery/infrastructure-music-lab-dreamspace-5.jpg"
                    data-thumb="../media/gallery/infrastructure-music-lab-dreamspace-5.jpg" alt="DreamSpace Academy" />
                <img src="../media/gallery/infrastructure-music-lab-dreamspace-6.jpg"
                    data-thumb="../media/gallery/infrastructure-music-lab-dreamspace-6.jpg" alt="DreamSpace Academy" />
            </div>
        </div>
    </div>
        ...
        <div class="template-component-call-to-action template-component-call-to-action-style-2 template-section-white">
            <div class="template-component-call-to-action-content">
                <div class="template-component-call-to-action-content-left">
                    <h6>
                        If you want to be part of Music Lab at DreamSpace Academy as an impact investor, partner, donor,
