...
<div class="template-content">
  <div class="template-content-section template-padding-top-reset template-main">
    <div class="template-component-header-subheader">
      <h2>DreamBot</h2>
      <h6>A multipurpose digital fabrication machine to empower the local manufacturing</h6>
      <div></div>
    </div>
    <div class="template-post">
      ...
      <div class="template-post-section-meta">
        <div class="template-post-meta">
          <div class="template-icon-blog template-icon-blog-author">
            <a target="_blank" href="http://arabot.aravinth.info/">araBot</a>
          </div>
          <div class="template-icon-blog template-icon-blog-author">
            <ul class="template-reset-list">
              <li><a target="_blank" href="https://www.linkedin.com/in/jerushan-sritharan-9017011b4/">Jerushan Sritharan</a></li>
            </ul>
          </div>
          <div class="template-icon-blog template-icon-blog-author">
            <a target="_blank" href="http://dreamspace.academy">DreamSpace Academy</a>
          </div>
        </div>
      </div>
      ...
      <div class="template-post-section-content">
        <div class="template-post-content">
          ...
          <h6 class="template-margin-top-3">TRUMPF</h6>
          <p class="template-padding-reset" align="justify">
            Global top 10 CNC machine tools companies in Mazak from Japan ranked first with 5.28 billion, German company TRUMPF ranked second with 4,2billiun. The top 10 list is occupied by Japan,Germany and the United states.
          </p>
          <p class="template-padding-reset" align="justify">
          ...
          <a target="_blank" href="https://www.trumpf.com/en_US/">[more]</a>
          <h6 class="template-margin-top-3">araBot</h6>
          <p class="template-padding-reset" align="justify">
          ...
          <a target="_blank" href="http://arabot.aravinth.info/">[more]</a>

          <h4 class="template-margin-top-3">Problem</h4>
          <h6 class="template-margin-top-3">Sculpture</h6>
          <p class="template-padding-reset" align="justify">
          ...
          <h6 class="template-margin-top-3">Unemployment</h6>
          <p class="template-padding-reset" align="justify">
          ...
          <h6 class="template-margin-top-3">DreamBot</h6>
          <p class="template-padding-reset" align="justify">
          ...
          <h6 class="template-margin-top-3">Time efficient</h6>
          <p class="template-padding-reset" align="justify">
          ...
          <h6 class="template-margin-top-3">Employment opportunities</h6>
          <p class="template-padding-reset" align="justify">
          ...
          <h6 class="template-margin-top-3">Cost effective</h6>
          <p class="template-padding-reset" align="justify">
          ...
          <h6 class="template-margin-top-3">User friendly</h6>
          <p class="template-padding-reset" align="justify">
          ...
          <p class="template-padding-reset" align="justify">
            By further developing the system we can develop that into 3 in 1 devices, that we can coordinate all the three; and make the work easy and minimize the time consumption as well. It will help the younger generation to develop their knowledge and create new career opportunities too. So he is planning to design and construct the 3 in 1 system and going to sell it to a reasonable price. Hence, He is requesting the help of international & local organizations and individuals to empower he in this endeavor, where he make sure that our young generation can make a big difference !!!
          </p>
