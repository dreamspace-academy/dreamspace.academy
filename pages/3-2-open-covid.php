...
<div class="template-content">
  <div class="template-content-section template-padding-top-reset template-main">
    <div class="template-component-header-subheader">
      <h2>Open Covid</h2>
      <h6>Open source innovative ideas to fight against the pandamic</h6>
      <div></div>
    </div>
    <div class="template-post">
      ...
      <div class="template-post-section-preambule">
        <div class="template-component-nivo-slider template-component-nivo-slider-style-2 template-preloader">
          <div>
            <img src="../media/images/innovation-open-covid/open-covid-dreamspace-1.jpg" data-thumb="../media/images/innovation-open-covid/open-covid-dreamspace-1.jpg" alt="DreamSpace Academy" />
            <img src="../media/images/innovation-open-covid/open-covid-dreamspace-2.jpg" data-thumb="../media/images/innovation-open-covid/open-covid-dreamspace-2.jpg" alt="DreamSpace Academy" />
            <img src="../media/images/innovation-open-covid/open-covid-dreamspace-3.jpg" data-thumb="../media/images/innovation-open-covid/open-covid-dreamspace-3.jpg" alt="DreamSpace Academy" />
            <img src="../media/images/innovation-open-covid/open-covid-dreamspace-4.jpg" data-thumb="../media/images/innovation-open-covid/open-covid-dreamspace-4.jpg" alt="DreamSpace Academy" />
            <img src="../media/images/innovation-open-covid/open-covid-dreamspace-5.jpg" data-thumb="../media/images/innovation-open-covid/open-covid-dreamspace-5.jpg" alt="DreamSpace Academy" />
          </div>
        </div>
      ...
      <div class="template-post-section-meta">
        <div class="template-post-meta">
          <div class="template-icon-blog template-icon-blog-author">
            <a target="_blank" href="https://jogl.io/">Just One Giant Lab</a>
          </div>
          <div class="template-icon-blog template-icon-blog-category">
            <ul class="template-reset-list">
              <li><a target="_blank" href="https://cults3d.com/en/orders/7298521">Open-source Mask</a></li>
            </ul>
          </div>
          <div class="template-icon-blog template-icon-blog-author">
            <a target="_blank" href="https://www.linkedin.com/in/nviththiyakaran/">Vithyakaran Nadarajah & Team</a>
          </div>
          <div class="template-icon-blog template-icon-blog-category">
            <ul class="template-reset-list">
              <li><a target="_blank" href="https://github.com/dreamspace-academy/dreamspace-coronabot">Corona Bot</a></li>
            </ul>
          </div>
        </div>
      </div>
      ...
      <div class="template-post-section-content">
        <div class="template-post-content">
          ...
          <h6 class="template-margin-top-3">Sri Lankan Innovators Battling COVID'19</h6>
          ...
          <a target="_blank" href="https://medium.com/igniterspace/sri-lankan-innovators-battling-covid-19-79c379beba5b">[more]</a>

          <h4 class="template-margin-top-3">Problem</h4>
          <h6 class="template-margin-top-3">The Pandemic</h6>
          <p class="template-padding-reset" align="justify">
          ...
          <h6 class="template-margin-top-3">Feasibility & Affordability</h6>
          <p class="template-padding-reset" align="justify">
          ...
          <h6 class="template-margin-top-3">Local Information Sharing Chatbox</h6>
          <p class="template-padding-reset" align="justify">
