...
<div class="template-content">
  <div class="template-content-section template-padding-top-reset template-main">
    <div class="template-component-header-subheader">
      <h2>Biodigester</h2>
      <h6>To eliminate the causes of waste management in Batticaloa by implementing and publicizing an excellent source of alternative energy</h6>
      <div></div>
    </div>
    <div class="template-post">
      ...
      <div class="template-post-section-preambule">
        <div class="template-component-nivo-slider template-component-nivo-slider-style-2 template-preloader">
          <div>
            <img src="../media/gallery/innovation-biodigester-dreamspace-1.jpg" data-thumb="../media/gallery/innovation-biodigester-dreamspace-1.jpg" alt="DreamSpace Academy" />
            <img src="../media/gallery/innovation-biodigester-dreamspace-2.jpg" data-thumb="../media/gallery/innovation-biodigester-dreamspace-2.jpg" alt="DreamSpace Academy" />
          </div>
        </div>
        ...
        <div class="template-post-meta">
          <div class="template-icon-blog template-icon-blog-author">
            <ul class="template-reset-list">
              <li><a target="_blank" href="https://www.linkedin.com/in/faahim-ismail-70a310147">Faahim Ismail</a></li>
            </ul>
          </div>
          <div class="template-icon-blog template-icon-blog-author">
      ...
      <div class="template-post-section-content">
        <div class="template-post-content">
          ...
          <h6 class="template-margin-top-3">Life beyond impact story - Oddamavadi bridge</h6>
          ...
          <h6 class="template-margin-top-3">Affordable and clean energy</h6>
          <p class="template-padding-reset" align="justify">
          ...
          <a target="_blank" href="https://www.undp.org/content/undp/en/home/sustainable-development-goals/goal-7-affordable-and-clean-energy.html">[more]</a>
          ...
          <h6 class="template-margin-top-3">Biodigester</h6>
          <p class="template-padding-reset" align="justify">
          ...
          <a target="_blank" href="https://wiki.opensourceecology.org/wiki/Biodigester">[more]</a>
