				...
				<div class="template-layout-50x50 template-clear-fix">
					...
					<div class="template-layout-column-left">
						...
						<div class="template-form-line template-state-block">
							<input type="text" class="form-control" placeholder="Your Name *" id="contactName" name="entry.426779947" required />
						</div>

						<!-- E-mail -->
						<div class="template-form-line template-state-block">
							<input type="text" class="form-control" placeholder="Your Email *" id="contactEmail" name="emailAddress" required />
						</div>

						<!-- Subject -->
						<div class="template-form-line template-state-block">
							<input type="text" class="form-control" placeholder="Your Subject *" id="contactOrg" name="entry.283178892" required />
						</div>
					...
					<div class="template-layout-column-right">
						<div class="template-form-line template-state-block">
							<textarea class="form-control" placeholder="Your Message *" id="contactMessage" name="entry.1888613089" required></textarea>
						</div>
					</div>
