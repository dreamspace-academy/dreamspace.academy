            ...
            <h3>
                <span>
                    ...
                    <p style="font-size:25px; color:#707070;">
                        Our mission is deep-rooted in establishing a sustainable Bioeconomy in Sri Lanka to create local
                        life-science and biotech innovations to address biomedical and ecological challenges.<br><br>
                        Bio Lab at DreamSpace academy provides an environment with unconditional access to education and
                        research infrastructure for the global community of biologists, citizen scientists, biohackers,
                        and changemakers to realise their ideas into knowledge, innovations and enterprises.
                    </p>
                </span>
            </h3>
        </div>
...
<div class="template-main template-padding-bottom-5" id="infrastructure">
    ...
    <div class="template-layout-column-left">
        <div class="template-component-nivo-slider template-component-nivo-slider-style-1 template-preloader">
            <div>
                <img src="../media/gallery/bio-lab-infrastructure-dreamspace-1.jpg"
                    data-thumb="../media/gallery/bio-lab-infrastructure-dreamspace-1.jpg" alt="DreamSpace Academy" />
                <img src="../media/gallery/bio-lab-infrastructure-dreamspace-2.jpg"
                    data-thumb="../media/gallery/bio-lab-infrastructure-dreamspace-2.jpg" alt="DreamSpace Academy" />
                <img src="../media/gallery/bio-lab-infrastructure-dreamspace-3.jpg"
                    data-thumb="../media/gallery/bio-lab-infrastructure-dreamspace-3.jpg" alt="DreamSpace Academy" />
                <img src="../media/gallery/bio-lab-infrastructure-dreamspace-4.jpg"
                    data-thumb="../media/gallery/bio-lab-infrastructure-dreamspace-4.jpg" alt="DreamSpace Academy" />
                <img src="../media/gallery/bio-lab-infrastructure-dreamspace-5.jpg"
                    data-thumb="../media/gallery/bio-lab-infrastructure-dreamspace-5.jpg" alt="DreamSpace Academy" />
                <img src="../media/gallery/bio-lab-infrastructure-dreamspace-6.jpg"
                    data-thumb="../media/gallery/bio-lab-infrastructure-dreamspace-6.jpg" alt="DreamSpace Academy" />
                <img src="../media/gallery/bio-lab-infrastructure-dreamspace-7.jpg"
                    data-thumb="../media/gallery/bio-lab-infrastructure-dreamspace-7.jpg" alt="DreamSpace Academy" />
            </div>
        </div>
    </div>
        ...
        <div class="template-component-counter-box">
            <ul class="template-layout-25x25x25x25 template-clear-fix">
                <li class="template-layout-column-left">
                    ...
                    <div>
                        <p>A workshop to get to know how to handle a microscope and how to prepare microscope slides.
                        </p>
                        </br>
                        </br>
                    </div>
                    <a target="_blank"
                        href="https://www.linkedin.com/posts/dreamspace-academy_biotech-education-entrepreneurship-activity-6931187217813946368-X6Iq?utm_source=linkedin_share&utm_medium=member_desktop_web"
                ...
                <li class="template-layout-column-center-left">
                    ...
                    <a target="_blank"
                        href="https://www.linkedin.com/posts/dreamspace-academy_biotechnology-education-innovation-activity-6938083014249697280-lEcH?utm_source=linkedin_share&utm_medium=member_desktop_web"
                        class="template-component-button template-component-button-style-1">More<i></i>
                    </a>
                </li>
            </ul>
        ...
        <div class="template-component-counter-box">
            <ul class="template-layout-25x25x25x25 template-clear-fix">
                ...
                <li class="template-layout-column-center-left">
                    ...
                    <a href="3-2-7-bio-digester.php"
                        class="template-component-button template-component-button-style-1">More<i></i></a>
                </li>
                <li class="template-layout-column-center-right">
                    <div
                        class="template-component-image template-component-counter-box-counter template-component-image-hover-slide-enable template-fancybox template-preloader">
                        <img src="../media/gallery/innovation-corona-hunter-dreamspace-0.jpg"
                    ...
                    <a href="3-2-4-corona-hunter.php"
                        class="template-component-button template-component-button-style-1">More<i></i></a>
                </li>
                ...
                <li class="template-layout-column-center-right">
                    <div
                        ...
                        <div
                            ...
                            <ul>
                                <li><a target="_blank"
                                        href="https://www.linkedin.com/in/nicholas-nico-crudele-07b3239a/">
                                        <i class="fab fa-linkedin-in fa-lg"
                                            style="color: white; padding-top: 17px;"></i>
                                    </a>
                                </li>
        ...
        <div class="template-component-call-to-action template-component-call-to-action-style-2 template-section-white">
            <div class="template-component-call-to-action-content">
                <div class="template-component-call-to-action-content-left">
                    <h6>
                        If you want to be part of Bio Lab at DreamSpace Academy as an impact investor, partner, donor,
                        team member or trainee, please reach out to us !!!
                    </h6>
                </div>
                <div class="template-component-call-to-action-content-right">
                    <a target="_blank"
                        href="https://docs.google.com/forms/d/e/1FAIpQLSdrTjjAj2xwsBqJOWOkXLjm5yBy52HuWPKglT90yUUGb4pLzA/viewform?usp=sf_link"
                        class="template-component-button template-component-button-style-2 template-section-white">Contact Us<i></i>
                    </a>
                </div>
            </div>
        </div>
