<div class="template-content-section template-padding-bottom-5 template-background-color-2" id="benzyme-ventures">
			...
			<div class="template-layout-column-right template-margin-bottom-reset">
				<div class="template-align-center">
					...
					<p class="template-margin-top-3">
						It is an innovative non-profit organization formed to provide support and guidance to bioscience enthusiasts.
					</p>
				    </br>
						</br>
