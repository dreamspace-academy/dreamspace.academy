...
<style>
  ...
  @media(max-width: 992px) {
    ...
    .fl-content-right-desktop {
      ...
      top: 0;
      display: block;
      /* Show it again below content */
      margin-top: 30px;
      order: 2;
      /* Make sure it appears after left content */
    }
        ...
        <div class="template-post">
          <div class="template-post-section-content">
            <div class="template-post-content">
              ...
              <p align="justify">
                Sri Lanka is facing one of the deadliest and most destructive disasters in recent history. Cyclone
                Ditwah and the island-wide floods have left communities devastated, homes destroyed, and thousands of
              ...
              <p align="justify">
                Entire neighbourhoods have been washed away or buried under mud. Districts including Colombo, Gampaha,
                Kandy, Nuwara Eliya, Badulla, Batticaloa, Mullaitivu, Trincomalee, Ampara, Ratnapura, and Monaragala
                have suffered catastrophic damage. Many regions remain without electricity, drinking water, or
                communication.
              </p>


              <p align="justify">
                Remote villages, including island communities, are accessible only by boat, leaving families trapped
                without food, medicine, or basic essentials.
              </p>
              ...
              <p align="justify">
                DreamSpace Academy, together with KathiraGreens, United Catalyst Network, and dedicated grassroots
                teams, is actively delivering support in some of the hardest-hit and most inaccessible regions.
              </p>
              ...
              <p align="justify">
                We have already supported over 100 families, but thousands more are waiting for urgent help. Every
                contribution helps us reach another family in need.
              </p>

              <h3 class="template-margin-top-3">You Can Help Save Lives</h3>
              <p align="justify">
                This is a moment for compassion and collective responsibility. Your generosity can help a family eat,
                stay safe, regain dignity, and begin rebuilding their lives.
              </p>
...
<script>
 ...
 `;
  ...
  const wiseData = `
   ...
   <b>Quick Pay Link (Wise Account Needed):</b></br>
   <a href="https://wise.com/pay/business/dreamspacefoundationgug"
  target="_blank"
  style="word-break: break-all;">
 https://wise.com/pay/business/dreamspacefoundationgug
</a><br><br>
