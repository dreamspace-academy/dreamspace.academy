<div class="template-content-section template-padding-bottom-5" id="her">
			...
			<div class="template-layout-column-left template-margin-bottom-reset">
				<div class="template-align-center">
					...
					<p class="template-margin-top-3">
						It is a woman empowerment initiative. We empower women through education, skill-based learning, tech education and career guidance. Because we believe empowered women empower women.</p>
					</br>
					</br>
					<div class="template-component-social-icon template-component-social-icon-style-1 template-clear-fix">
						<a target="_blank" href="https://www.facebook.com/hersrilanka" class="template-component-button template-component-button-style-1">More<i></i></a>
					</div>
				</div>
			</div>
