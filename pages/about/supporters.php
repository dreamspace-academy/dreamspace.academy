			...
			<ul class="template-layout-50x50 template-clear-fix">
						...
						<li class="template-layout-column-left">
							<div class="template-component-image template-component-image-hover-slide-enable template-fancybox template-preloader">
								...
								<div>
									...
									<span>Advisor & Trainer - Design Thinking</span>
								</div>
								<p><b>Maite Hernandez Zubeldia</b> Advisor & Trainer - Design Thinking</p>
							</div>
						</li>
						<li class="template-layout-column-right">
							<div class="template-component-team-quote"></div>
							<p class="template-component-team-description" style="text-align: justify">Maite’s core experience is in impact-driven entrepreneurship, human-centric design and agile product development. She has a strong passion for bridging the gap between humanity and technology. While working in Europe, Canada, Cuba and Sri Lanka, she has experienced innovation approaches in different regions of the world.
				...
				<li class="template-layout-column-right">
				  <ul class="template-layout-50x50 template-clear-fix">
				    <li class="template-layout-column-left">
				      <div class="template-component-image template-component-image-hover-slide-enable template-fancybox template-preloader">
				        <a href="../../media/images/about/supporters/darina-dreamspace.png" data-fancybox-group="team-2">
				          <img src="../../media/images/about/supporters/darina-dreamspace.png" alt="darina-dreamspace.png" />
				          <span><span><span></span></span></span>
				        </a>
				        <div>
				          <h6>Darina Onoprienko</h6>
				          <span>Advisor & Trainer - Entrepreneurship</span>
				        </div>
				        <p><b>Darina Onoprienko</b> Advisor & Trainer - Entrepreneurship</p>
				      </div>
				    </li>
				    <li class="template-layout-column-right">
				      <div class="template-component-team-quote"></div>
				      <p class="template-component-team-description" style="text-align: justify">The areas of my professional interest are Internet of Things, blockchain, cleantech, sustainable transportation and supply chain management, design thinking and innovation management, entrepreneurship. </p>
				      <div class="template-component-social-icon template-component-social-icon-style-1 template-clear-fix">
				        <ul>
				          <li><a href="https://www.linkedin.com/in/darina-onoprienko-6b5b8843/" class="template-component-social-icon-linkedin"></a></li>
				        </ul>
				      </div>
				    </li>
				  </ul>
				...
				<li class="template-layout-column-left">
				  <ul class="template-layout-50x50 template-clear-fix">
				    <li class="template-layout-column-left">
				      <div class="template-component-image template-component-image-hover-slide-enable template-fancybox template-preloader">
				        <a href="../../media/images/about/supporters/luise-dreamspace.png" data-fancybox-group="team-2">
				          <img src="../../media/images/about/supporters/luise-dreamspace.png" alt="luise-dreamspace.png" />
				          <span><span><span></span></span></span>
				        </a>
				        <div>
				          <h6>Luise Kröning</h6>
				...
				<li class="template-layout-column-right">
				  <ul class="template-layout-50x50 template-clear-fix">
				    <li class="template-layout-column-left">
				      <div class="template-component-image template-component-image-hover-slide-enable template-fancybox template-preloader">
				        <a href="../../media/images/about/supporters/zoe-dreamspace.png" data-fancybox-group="team-2">
				          <img src="../../media/images/about/supporters/zoe-dreamspace.png" alt="zoe-dreamspace.png" />
				          <span><span><span></span></span></span>
				        </a>
				        <div>
