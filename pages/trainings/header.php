...
<html class="template-page-home-1">
	...
	<head>
		...
		<meta name="description" content="Community Innovation Center to tackle authentic socio-economic and environmental challenges using Project Based Learning (PBL)" />
					...
					<div class="template-header-top-menu template-clear-fix">
						...
						<nav class="template-component-menu-default">
							<ul class="sf-menu template-clear-fix">
								...
								<!-- Trainings Menu -->
								<li class="sf-mega-enable-0">
									<a href="index.php"><span class="template-icon-menu template-icon-menu-lab"></span>Trainings</a>
									<ul>
										<li><a href="#maker-education">Maker Education</a></li>
										<li><a href="#design-thinking">Design Thinking</a></li>
										<li><a href="#instrumental-music">Instrumental Music</a></li>
										<li><a href="#information-technology">Information Technology</a></li>
										<li><a href="#access-programme">Access Programme</a></li>
										<li><a href="#studies-of-languages">Studies of Languages</a></li>
									</ul>
								</li>
								<!-- Communities Menu -->
								<li class="sf-mega-enable-0">
									<a href="../communities/community-innovation/index.php"><span class="template-icon-menu template-icon-menu-people"></span>Communities</a>
									<ul>
										<li><a href="../communities/community-innovation/index.php">Community Innovation</a></li>
										<li><a href="../communities/dream-terrace/index.php">DreamTerrace</a></li>
										<li><a href="../communities/urban-farming/index.php">Urban Farming</a></li>
										<li><a href="../communities/digital-nomads/index.php">Digital Nomads</a></li>
										<li><a href="../communities/smart-mobility/index.php">Smart Mobility</a></li>
										<li><a href="../communities/floss-boats/index.php">Floss Boats</a></li>
										<li><a href="../communities/underwater-vehicles/index.php">Underwater Vehicles</a></li>
									</ul>
								</li>
								<!-- Links Menu -->
								<li class="sf-mega-enable-0">
