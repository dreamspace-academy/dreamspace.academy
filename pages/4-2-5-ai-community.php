<div class="template-content" id="ai-community">
    ...
    <div class="template-component-gallery">
      <ul class="template-layout-25x25x25x25 template-clear-fix">
        ...
        <li class="template-layout-column-right">
          <div class="template-component-image template-component-image-hover-slide-enable template-fancybox template-preloader">
            <img src="../media/people/grashini-thangavadivel-dreamspace.jpg" alt="DreamSpace Academy" />
            <div>
              <h6>Grashini Thangavadivel</h6>
              </br>
              </br>
              <span>Batticaloa</span>
            </div>
        ...
        <li class="template-layout-column-center-left">
          <div class="template-component-image template-component-image-hover-slide-enable template-fancybox template-preloader">
            <img src="../media/people/john-heven-ragel-dreamspace.jpg" alt="DreamSpace Academy" />
            <div>
              <h6>John Heven Ragel</h6>
              </br>
              </br>
              <span>Batticaloa</span>
            </div>
        ...
        <li class="template-layout-column-center-right">
          <div class="template-component-image template-component-image-hover-slide-enable template-fancybox template-preloader">
            <img src="../media/people/mohamed-rafeek-thaqee-ahamed-dreamspace.jpg" alt="DreamSpace Academy" />
            <div>
              <h6>Mohamed Rafeek Thaqee Ahamed</h6>
              </br>
              <span>Batticaloa</span>
            </div>
            <div class="template-component-social-icon template-component-social-icon-style-1 template-clear-fix">
        ...
        <li class="template-layout-column-right">
          <div class="template-component-image template-component-image-hover-slide-enable template-fancybox template-preloader">
            <img src="../media/people/niroshan-sinnathurai-dreamspace.jpg" alt="DreamSpace Academy" />
            <div>
              <h6>Niroshan Sinnathurai</h6>
              </br>
              </br>
              <span>Batticaloa</span>
            </div>
        ...
        <li class="template-layout-column-center-left">
          <div class="template-component-image template-component-image-hover-slide-enable template-fancybox template-preloader">
            <img src="../media/people/evanjaline-raveendran-dreamspace.jpg" alt="DreamSpace Academy" />
            <div>
              <h6>Evanjaline Raveendran</h6>
            </br>
              <span>Batticaloa</span>
            </div>
            <div class="template-component-social-icon template-component-social-icon-style-1 template-clear-fix">
        ...
        <li class="template-layout-column-center-right">
          <div class="template-component-image template-component-image-hover-slide-enable template-fancybox template-preloader">
            <img src="../media/people/lojana-jegatheeswaran-dreamspace.jpg" alt="DreamSpace Academy" />
            <div>
              <h6>Lojana Jegatheeswaran</h6>
            </br>
