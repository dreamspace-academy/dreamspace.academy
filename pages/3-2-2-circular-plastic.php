    ...
    <div class="template-post">
      ...
      <div class="template-post-section-content">
        <div class="template-post-content">
          ...
          <h6 class="template-margin-top-3">Sri Lanka: A great ocean polluter with plastics</h6>
          ...
          <a target="_blank" href="https://loopsagency.com/sri-lanka-ranked-as-the-5th-largest-plastic-polluter-in-the-world/">[more]</a>
          <h6 class="template-margin-top-3">Marine diversity in Sri Lanka</h6>
          <p class="template-padding-reset" align="justify">
          ...
          <a target="_blank" href="https://window2nature.wordpress.com/2013/01/05/the-sundaytimes-sri-lanka-icun-2013-desk-calendar-features-marine-wonders/">[more]</a>

          <h4 class="template-margin-top-3">Problem</h4>
          <h6 class="template-margin-top-3">Ocean Water Contamination</h6>
          <p class="template-padding-reset" align="justify">
          ...
          <h6 class="template-margin-top-3">Solid Waste Management</h6>
          <p class="template-padding-reset" align="justify">
          ...
          <h6 class="template-margin-top-3">Circular Plastic</h6>
          <p class="template-padding-reset" align="justify">
        ...
        <a target="_blank" href="https://preciousplastic.com/index.html">[more]</a>
          ...
          <div class="template-component-feature template-component-feature-style-1 template-component-feature-position-left template-component-feature-size-medium">
            <ul class="template-layout-33x33x33 template-clear-fix">
              <li class="template-layout-column-left">
                <div class="template-icon-feature"><img src="../media/logos/sdg-dreamspace-12.png" alt="DreamSpace Academy" /></div>
              ...
              <li class="template-layout-column-right">
                <div class="template-icon-feature"><img src="../media/logos/sdg-dreamspace-11.png" alt="DreamSpace Academy" /></div>
